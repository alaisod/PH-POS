...
class Sale_lib
{
	...
	{
		return $this->CI->session->userdata('delivery_tax_group_id') ? $this->CI->session->userdata('delivery_tax_group_id') : NULL;
	}
	...
	*/
	...
	function add_scale_item($scan)
	{
		...
		return $this->add_item($data['item_id'],to_quantity($data['sell_quantity']),0,$data['sell_price']);
	}		
