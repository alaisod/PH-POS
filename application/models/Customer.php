	...
	*/
	...
	function get_displayable_columns()
	{
		$columns = array(
			...
			'email' => 													array('sort_column' => $this->db->dbprefix('people').'.last_name','label' => lang('common_email'),'format_function' => 'email_formatter','html' => TRUE),
			'phone_number' => 									array('sort_column' => $this->db->dbprefix('people').'.last_name','label' => lang('common_phone_number')),
