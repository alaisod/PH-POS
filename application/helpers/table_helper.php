...
function get_item_data_row($item,$controller)
{
	...
	$table_data_row.='<td class="rightmost">'.
					'<div class="piluku-dropdown dropup btn-group table_buttons">
						...
						if (!$item->is_service)
						{
							$table_data_row.= '<li>'. anchor($controller_name."/inventory/$item->item_id/", '<i class="ion-android-clipboard"></i> ' .  lang('common_item') .' ' . lang('common_count') , array('class'=>'','title'=>lang($controller_name.'_count'))).'</li>';
						}
