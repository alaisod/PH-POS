...
<div class="row register">
			...
			<?php
				...
				?>
					<tr class="<?php echo $row_class; ?>">
						...
						<td class="sp_charge text-center"><?php echo to_currency($unpaid_sale['payment_amount']);?></td>
	...
	<div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 no-padding-right">
      ...
      <?php if($mode!='store_account_payment' && $customer_has_address && $this->Employee->has_module_action_permission('deliveries', 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
