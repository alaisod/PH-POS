            ...
            else
            {
				...
				$(".checkForUpdate").click(function(event)
				{
					...
					$.getJSON($(this).attr('href'), function(update_available) 
					{
						...
						if(update_available)
						{
							$(".checkForUpdate").parent().html(<?php echo json_encode(lang('common_update_available').' <a href="http://www.ogpos.com/downloads.php" target="_blank">'.lang('common_download_now').'</a>');?>);
						}
						else
						{
