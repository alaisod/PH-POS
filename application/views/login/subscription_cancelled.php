            ...
            <div class="front">
                ...
                <div class="holder">
					<p>
					    ...
					    <a class="btn btn-block btn-sm btn-danger" href="https://alaisod.com/update_billing.php?store_username=<?php echo $cloud_customer_info['username'];?>" target="_blank"><?php echo lang('login_resignup');?></a>
					</p>
				</div>
			</div>
		</div>
