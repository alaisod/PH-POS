			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="mercury_activate_container">
						<h3><a href="http://www.ogpos.com/credit_card_processing.php" target="_blank"><?php echo lang('common_credit_card_processing'); ?></a></h3>
						<a href="http://www.ogpos.com/credit_card_processing.php" class="mercury_description" target="_blank">
