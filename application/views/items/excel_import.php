			            ...
			            <div class="col-md-12 well text-center">
		                	<h4 class="text-center"><?php echo lang('common_download_spreadsheet_template'); ?></h4>
		               	 	<p class="text-center"><?php echo lang('common_download_spreadsheet_template_description'); ?></p>
											<a href="<?php echo site_url('items/excel_export') ?>" class="btn btn-primary"><?php echo lang('items_update_items_import'); ?></a>
											<a href="<?php echo site_url('items/excel') ?>" class="btn btn-primary"><?php echo lang('items_new_items_import'); ?></a>
			            </div>
			        </div>
				        <div class="col-xs-12">
				...
				onDataLoaded: function(args) {
					...
					var done = function(){
						...
						for (var x in columns) 
						{
							...
							{ //'Item Name' must be mapped to move to step 3
								if(columns[x]['Database Field'] === 2)
								{
									//enable step 3
