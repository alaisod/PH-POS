...
class Config extends Secure_area 
{
	...
	function index()
	{
		...
		//add woo New Version : woo APIV.3 for woocommerce 3.5 up!  gomonx
		$data['woo_versions'] = array('3.5.0'=>'3.5.0 UP','3.0.0'=>'3.0.0', '2.6.14'=>'2.6.0 to 2.6.14');
	...
	function save()
	{
      ...
      curl_close($ch);		
		...
		if (is_on_demo_host())
		{
			...
			$batch_save_data['company_logo'] = 0;
			$batch_save_data['company'] = 'OCOM POS, Inc';
