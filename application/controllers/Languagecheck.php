								...
								elseif($lang[$key] == $lang_ref[$key])
								{
									if (!$disable_white_list)
									{
										$white_list = array(
											...
											'migrate_item_lookup_order','migrate_ecommerce_performance_improvements','migrate_price_tiers_cost_plus_fixed_amount','sales_id','deliveries_search','reports_total_due'
										);
									}
									else
									{
