SET SESSION sql_mode='STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';SET FOREIGN_KEY_CHECKS=0;
-- MySQL dump 10.13  Distrib 8.0, for osx10.9 (x86_64)
--
...
CREATE TABLE `phppos_currency_exchange_rates` (
  ...
  `currency_code_to` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_symbol` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `exchange_rate` decimal(23,10) NOT NULL,
  `currency_symbol_location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `number_of_decimals` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `thousands_separator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `decimal_point` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phppos_customers` (
  ...
  `tax_certificate` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `cc_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cc_ref_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cc_preview` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_issuer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `tier_id` int(10) DEFAULT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
  `tax_class_id` int(10) DEFAULT NULL,
  `custom_field_1_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_field_2_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_field_3_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_field_4_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_field_5_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `phppos_ecommerce_categories` (
  `ecommerce_category_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_ecommerce_tags` (
  `ecommerce_tag_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_employees` (
  ...
  `commission_percent_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `hourly_pay_rate` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  `not_required_to_clock_in` int(1) NOT NULL DEFAULT '0',
  `inactive` int(1) NOT NULL DEFAULT '0',
  `reason_inactive` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `phppos_employees_time_clock` (
  ...
  `clock_in_comment` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `clock_out_comment` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `hourly_pay_rate` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  `ip_address_clock_in` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip_address_clock_out` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `phppos_expenses` (
  ...
  `expense_note` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `employee_id` int(10) NOT NULL,
...
CREATE TABLE `phppos_giftcards` (
  ...
  `giftcard_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `phppos_inventory` (
  ...
  `trans_comment` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_inventory_counts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `count_date` timestamp DEFAULT NULL,
  `employee_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
...
CREATE TABLE `phppos_item_images` (
  ...
  `ecommerce_image_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `phppos_item_kits` (
  ...
  `item_kit_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `disable_loyalty` int(1) NOT NULL DEFAULT '0',
  `deleted` int(1) NOT NULL DEFAULT '0',
  `aaatex_qb_item_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `tax_class_id` int(10) DEFAULT NULL,
...
CREATE TABLE `phppos_items` (
  ...
  `product_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ecommerce_product_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_locations` (
  ...
  `receive_stock_alert` text COLLATE utf8mb4_unicode_ci,
  `stock_alert_email` text COLLATE utf8mb4_unicode_ci,
  `timezone` text COLLATE utf8mb4_unicode_ci,
  `mailchimp_api_key` text COLLATE utf8mb4_unicode_ci,
  `enable_credit_card_processing` text COLLATE utf8mb4_unicode_ci,
  `credit_card_processor` text COLLATE utf8mb4_unicode_ci,
  `hosted_checkout_merchant_id` text COLLATE utf8mb4_unicode_ci,
  `hosted_checkout_merchant_password` text COLLATE utf8mb4_unicode_ci,
  `emv_merchant_id` text COLLATE utf8mb4_unicode_ci,
  `net_e_pay_server` text COLLATE utf8mb4_unicode_ci,
  `listener_port` text COLLATE utf8mb4_unicode_ci,
  `com_port` text COLLATE utf8mb4_unicode_ci,
  `stripe_public` text COLLATE utf8mb4_unicode_ci,
  `stripe_private` text COLLATE utf8mb4_unicode_ci,
  `stripe_currency_code` text COLLATE utf8mb4_unicode_ci,
  `braintree_merchant_id` text COLLATE utf8mb4_unicode_ci,
  `braintree_public_key` text COLLATE utf8mb4_unicode_ci,
  `braintree_private_key` text COLLATE utf8mb4_unicode_ci,
  `default_tax_1_rate` text COLLATE utf8mb4_unicode_ci,
  `default_tax_1_name` text COLLATE utf8mb4_unicode_ci,
  `default_tax_2_rate` text COLLATE utf8mb4_unicode_ci,
  `default_tax_2_name` text COLLATE utf8mb4_unicode_ci,
  `default_tax_2_cumulative` text COLLATE utf8mb4_unicode_ci,
  `default_tax_3_rate` text COLLATE utf8mb4_unicode_ci,
  `default_tax_3_name` text COLLATE utf8mb4_unicode_ci,
  `default_tax_4_rate` text COLLATE utf8mb4_unicode_ci,
  `default_tax_4_name` text COLLATE utf8mb4_unicode_ci,
  `default_tax_5_rate` text COLLATE utf8mb4_unicode_ci,
  `default_tax_5_name` text COLLATE utf8mb4_unicode_ci,
  `deleted` int(1) DEFAULT '0',
  `secure_device_override_emv` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `secure_device_override_non_emv` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `tax_class_id` int(10) DEFAULT NULL,
...
CREATE TABLE `phppos_modules` (
  `name_lang_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desc_lang_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_modules_actions` (
  `action_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `module_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_name_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phppos_receivings` (
  ...
  `deleted_taxes` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `phppos_register_currency_denominations` VALUES (1,'แบงค์ 1,000',1000),(2,'แบงค์ 500',500),(3,'แบงค์ 100',100),(4,'แบงค์ 50',50),(5,'แบงค์ 20',20),(6,'เหรียญ 10',10),(7,'เหรียญ 5',5),(8,'เหรียญ 2',2),(9,'เหรียญ 1',1);
...
CREATE TABLE `phppos_registers` (
  ...
  `location_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `iptran_device_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `emv_terminal_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `phppos_sales` (
  ...
  `payment_type` text COLLATE utf8mb4_unicode_ci,
  `cc_ref_no` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `auth_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `deleted_by` int(10) DEFAULT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
  `suspended` int(1) NOT NULL DEFAULT '0',
  `store_account_payment` int(1) NOT NULL DEFAULT '0',
  ...
  `exchange_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `exchange_currency_symbol` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `exchange_currency_symbol_location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `exchange_number_of_decimals` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `exchange_thousands_separator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `exchange_decimal_point` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`sale_id`),
...
CREATE TABLE `phppos_sales_payments` (
  ...
  `payment_amount` decimal(23,10) NOT NULL,
  `auth_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `ref_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `cc_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `acq_ref_data` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `process_data` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `entry_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `aid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `tvr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `iad` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `tsi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `arc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `cvm` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `tran_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `application_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `truncated_card` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `card_issuer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `payment_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ebt_auth_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `ebt_voucher_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  PRIMARY KEY (`payment_id`),
  KEY `sale_id` (`sale_id`),
  KEY `payment_date` (`payment_date`),
